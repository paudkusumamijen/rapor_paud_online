      ...
      <div className="space-y-6">
             ...
             <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select className="w-full p-2 border rounded-lg bg-white text-slate-800 disabled:bg-slate-100 disabled:text-slate-400" value={selectedStudentId} onChange={e => { setSelectedStudentId(e.target.value); setActiveCritId(null); }} disabled={!selectedClassId}>
             ...
             {selectedStudentId ? (
                 <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            {existing ? (
                                                <div className="mt-2 text-sm text-slate-600">
                                                    <span className="inline-block bg-teal-100 text-teal-800 px-2 py-0.5 rounded text-xs font-bold mr-2">{existing.score === 1 ? 'Berkembang' : existing.score === 2 ? 'Cakap' : 'Mahir'}</span>
                    ...
                    ) : ( <div className="text-center p-8 bg-orange-50 rounded-xl border border-orange-200"><p className="text-orange-800 font-medium">Belum ada data Sub Dimensi untuk kelas ini.</p><p className="text-sm mt-2 text-orange-600">Silakan masuk ke menu "Data Master > Data P5" untuk menambahkan data.</p></div> )}
                 </div>
