    ...
    <div>
                ...
                <table className="w-full text-left text-sm">
                    ...
                    <tbody className="text-slate-700">
                        {p5Criteria.map(c => (
                         ...
                         {p5Criteria.length === 0 && <tr><td colSpan={3} className="p-8 text-center text-slate-400">Belum ada data sub dimensi.</td></tr>}
                    </tbody>
                </table>
            </div>
        </div>
      ...
      {activeTab === 'assessment' && (
        <div className="space-y-6">
             ...
             {selectedStudentId ? (
                 <div className="space-y-4">
                    <h3 className="font-bold text-lg text-slate-800 border-b pb-2">Daftar Sub Dimensi P5</h3>
                    {p5Criteria.length > 0 ? (
                        p5Criteria.map(c => {
